...
class LayeredImages {
    ...
    drawTheLayer (currentContext, camera) {     // Will store all of the draw functions that are pushed here into the imageLayers array. This will result in the image being drawn to the screen.   
